...
public enum BizErrorCode {
    ...
    OTP_LOCKED(1012, "error.verification-code.locked", "Verification code is temporarily locked"),
    EMAIL_EXISTS(2001, "auth.email.exists", "Email already registered"),
    NICKNAME_EXISTS(2007, "auth.nickname.exists", "Nickname already taken"),
